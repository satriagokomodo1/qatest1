...
public class CorpcomCreateRFQ_Prod extends BuyerLoginCommerce1PageObject {
    ...
    public CorpcomCreateRFQ_Prod InputEmail() throws InterruptedException {
        ...
        inputEmail.sendKeys(decryptData(BuyerInitMethod.appConfig.getProduction1()));
        return this;
    }
    ...
    public CorpcomCreateRFQ_Prod InputPassword() {
        ...
        inputPassword.sendKeys(decryptData(BuyerInitMethod.appConfig.getPasswordProd()));
        return this;
    }
...
//    }
  ...
  //      highlightElement(UploadFileRFQ);
        UploadFileRFQ.sendKeys(BuyerInitMethod.appConfig.getAttachemntCorpcomm1());
    return this;
    }
