package Gokomodo.FE.Mobile.Seller.controllers;


import Gokomodo.FE.Mobile.Seller.utils.MobileSellerEnvironmentSetup;
...
public class MobileSellerBaseMethod {
        ...
        try {
            ...
            switch (platformName) {
                case "Android":
                    ...
                    desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, GetAndroidSellerAppPackage);
                    desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, GetAndroidSellerAppActivity);
...
//                    desiredCapabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, GetIOSPlatformVersion);
                    ...
                    File iOSAppUrl = new File(iOSParentDirectoryPath, GetIOSSellerAppName);
    ...
    public void scrollDown() {
        ...
        MobileSellerW3cActions.doSwipe(getDriver(), start, end, 1000);  //with duration 1s
    ...
    public void scrollUp() {
        ...
        MobileSellerW3cActions.doSwipe(getDriver(), end, start, 1000);  //with duration 1s
    ...
    public void afterClass() {
        MobileSellerEnvironmentSetup.environmentSetup();
        getDriver().quit();
    }
