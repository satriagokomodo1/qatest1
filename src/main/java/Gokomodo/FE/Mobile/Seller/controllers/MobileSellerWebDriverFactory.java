...
import Gokomodo.FE.Mobile.Buyer.controllers.MobileBuyerInitMethod;
...
public class MobileSellerWebDriverFactory extends MobileSellerBaseMethod {



    @BeforeMethod
    public void beforeMethod() throws Exception {
        if (MobileBuyerInitMethod.VideoFeature.toLowerCase().contains("enabledfailed")) {
            setupVideoRecordingFailedOnly();
        } else if (MobileBuyerInitMethod.VideoFeature.toLowerCase().contains("enabledall")) {
    ...
    public MobileSellerWebDriverFactory() {
