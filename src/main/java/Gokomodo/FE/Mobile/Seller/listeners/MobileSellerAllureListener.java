package Gokomodo.FE.Mobile.Seller.listeners;

import Gokomodo.FE.Mobile.Seller.utils.MobileSellerAllureAttachments;
import Gokomodo.FE.Mobile.Seller.controllers.MobileSellerBaseMethod;
import org.testng.*;


public class MobileSellerAllureListener extends MobileSellerBaseMethod implements ITestListener, ISuiteListener, IInvokedMethodListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        MobileSellerAllureAttachments.saveFullPageScreenshot(Name, getDriver());
    }
