...
import Gokomodo.FE.Mobile.Buyer.utils.MobileBuyerEnvironmentSetup;
...
public class MobileBuyerBaseMethod {
    ...
    public void beforeClass(String emulator, String platformName, String deviceName ) throws Exception {
        ...
        try {
            ...
            url = new URL(MobileBuyerInitMethod.GetAppiumUrl);
            switch (platformName) {
                case "Android":
                    ...
                    File androidAppUrl = new File(androidParentDirectoryPath, GetAndroidBuyerAppName);
                    desiredCapabilities.setCapability(MobileCapabilityType.APP, androidAppUrl.getAbsolutePath());
                    desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, GetAndroidBuyerAppPackage);
                    desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, GetAndroidBuyerAppActivity);
                ...
                case "iOS":
                    ...
                    desiredCapabilities.setCapability(IOSMobileCapabilityType.BUNDLE_ID, GetIOSBuyerBundleId);
...
//                    desiredCapabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, GetIOSPlatformVersion);
                    File iOSParentDirectoryPath = new File(GetIOSAppLocation);
                    File iOSAppUrl = new File(iOSParentDirectoryPath, GetIOSBuyerAppName);
    ...
    {
        URL aURL = new URL(MobileBuyerInitMethod.WebsiteURLBuyer);
    ...
    public void scrollDown() {
        ...
        MobileBuyerW3cActions.doSwipe(getDriver(), start, end, 1000);  //with duration 1s
    ...
    public void scrollUp() {
        ...
        MobileBuyerW3cActions.doSwipe(getDriver(), end, start, 1000);  //with duration 1s
    ...
    public void afterClass() {
        MobileBuyerEnvironmentSetup.environmentSetup();
        getDriver().quit();
    }
