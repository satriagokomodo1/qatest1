package Gokomodo.FE.Mobile.Buyer.listeners;

import Gokomodo.FE.Mobile.Buyer.controllers.MobileBuyerBaseMethod;
import Gokomodo.FE.Mobile.Buyer.utils.MobileBuyerAllureAttachments;
import org.testng.*;


public class MobileBuyerAllureListener extends MobileBuyerBaseMethod implements ITestListener, ISuiteListener, IInvokedMethodListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        MobileBuyerAllureAttachments.saveFullPageScreenshot(Name, getDriver());
    }
