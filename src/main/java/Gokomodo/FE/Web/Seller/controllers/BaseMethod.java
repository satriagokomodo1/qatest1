...
import Gokomodo.FE.Web.Seller.utils.EnvironmentSetup;
...
public class BaseMethod extends WebDriverFactory
{
	...
	{
		URL aURL = new URL(WebsiteURLSeller);
	...
	//1500
	public void scrollDown1500() { ((JavascriptExecutor) getWebDriver()).executeScript("scroll(0, 1500);"); }
