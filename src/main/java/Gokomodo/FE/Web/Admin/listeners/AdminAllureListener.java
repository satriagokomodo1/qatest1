package Gokomodo.FE.Web.Admin.listeners;

import Gokomodo.FE.Web.Admin.controllers.AdminBaseMethod;
import Gokomodo.FE.Web.Admin.utils.AdminAllureAttachments;
import org.testng.*;


public class AdminAllureListener extends AdminBaseMethod implements ITestListener, ISuiteListener, IInvokedMethodListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        AdminAllureAttachments.saveFullPageScreenshot(Name, getWebDriver());
    }
