    ...
    public static Object[][] getTableArray(String FilePath, String SheetName) throws Exception {
        ...
        try {
            ...
            if (file.getAbsolutePath().endsWith(".xlsx")) {
                ...
                int startCol = 0;
                int ci, cj;
                int totalRows = AdminExcelUtils.xlsxRowCount();
                int totalCols = AdminExcelUtils.xlsxColumnCount();
                ...
                int startCol = 0;
                int ci, cj;
                int totalRows = AdminExcelUtils.xlsRowCount();
                int totalCols = AdminExcelUtils.xlsColumnCount();
                tabArray = new Object[totalRows - 1][totalCols];
                ci = 0;
                for (int i = startRow; i < totalRows; i++) {
                    cj = 0;
