...
import Gokomodo.FE.Web.Admin.utils.AdminEnvironmentSetup;
...
public class AdminBaseMethod extends AdminWebDriverFactory
{
	@AfterTest
	public void beforeSuite() throws Exception
	{
		AdminEnvironmentSetup.environmentSetup();
	}
	
	/* To get the Website Name */
	public String getUrlTitle() throws Exception 
	{
		URL aURL = new URL(WebsiteURLAdmin);
