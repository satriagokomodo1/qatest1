...
public class AdminWebDriverFactory extends AdminBrowserFactory {
    ...
    public void suiteSetup() {
        switch (BrowserGlobal.toLowerCase()) {
            case "chrome":
...
//                break;
    ...
    public void beforeMethod() throws Exception {
        System.out.println("Browser: " + BrowserGlobal);
        System.out.println("WebsiteURL: " + WebsiteURLAdmin);
        new AdminWebDriverFactory();
