...
public class AdminInitMethod {
    public static AdminApplicationConfigReader appConfig = new AdminApplicationConfigReader();

    public static String UserAdmin = appConfig.getUserAdmin();
    public static String PassAdmin = appConfig.getPassAdmin();
    ...
    public static String BrowserGlobal = appConfig.getBrowserGlobal();
