package Gokomodo.FE.MobileWeb.Admin.controllers;
...
public class MobileWebAdminInitMethod {

    public static MobileWebAdminApplicationConfigReader appConfig = new MobileWebAdminApplicationConfigReader();
    ...
    public static String Usradmin = appConfig.getUserAdmin();
    ...
    public static String GetAndroidAppPackage = appConfig.getAndroidAppPackage();
    public static String GetAndroidAppActivity = appConfig.getAndroidAppActivity();
    public static String GetAndroidAppName = appConfig.getAndroidAppName();
    ...
    public static String GetIOSBundleId = appConfig.getIOSBundleId();
    public static String GetIOSAppLocation = appConfig.getIOSAppLocation();
    public static String GetIOSAppName = appConfig.getIOSAppName();
