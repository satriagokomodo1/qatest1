...
public class MobileWebAdminDriverFactory extends MobileWebAdminBaseMethod {
...
//        new MobileWebBuyerWebDriverFactory();
        ...
        if (MobileWebAdminInitMethod.VideoFeature.toLowerCase().contains("enabledfailed")) {
            setupVideoRecordingFailedOnly();
        } else if (MobileWebAdminInitMethod.VideoFeature.toLowerCase().contains("enabledall")) {
    ...
    public MobileWebAdminDriverFactory() {
