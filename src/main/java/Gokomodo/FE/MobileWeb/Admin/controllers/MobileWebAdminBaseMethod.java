...
import Gokomodo.FE.MobileWeb.Admin.utils.MobileWebAdminEnvironmentSetup;
...
public class MobileWebAdminBaseMethod {
    ...
    public MobileWebAdminBaseMethod() {
    ...
    public void beforeClass(String emulator, String platformName, String deviceName) throws Exception {
        ...
        try {
            ...
            url = new URL(MobileWebAdminInitMethod.GetAppiumUrl);
            switch (platformName) {
                case "Android":
...
//                    desiredCapabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, GetIOSPlatformVersion);
    ...
    {
        URL aURL = new URL(MobileWebAdminInitMethod.WebsiteURLBuyer);
    ...
    public void scrollDown() {
        ...
        MobileWebAdminW3cActions.doSwipe(getDriver(), start, end, 1000);  //with duration 1s
    ...
    public void scrollUp() {
        ...
        MobileWebAdminW3cActions.doSwipe(getDriver(), end, start, 1000);  //with duration 1s
    ...
    public void afterClass() {
        MobileWebAdminEnvironmentSetup.environmentSetup();
        getDriver().quit();
    }
