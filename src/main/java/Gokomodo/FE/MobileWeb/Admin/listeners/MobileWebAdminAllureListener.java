package Gokomodo.FE.MobileWeb.Admin.listeners;

import Gokomodo.FE.MobileWeb.Admin.controllers.MobileWebAdminBaseMethod;
import Gokomodo.FE.MobileWeb.Admin.utils.MobileWebAdminAllureAttachments;
import org.testng.*;


public class MobileWebAdminAllureListener extends MobileWebAdminBaseMethod implements ITestListener, ISuiteListener, IInvokedMethodListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        MobileWebAdminAllureAttachments.saveFullPageScreenshot(Name, getDriver());
    }
