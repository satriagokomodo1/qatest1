...
public class MobileWebSellerInitMethod {

    public static MobileWebSellerApplicationConfigReader appConfig = new MobileWebSellerApplicationConfigReader();
    ...
    public static String UserSeller = appConfig.getUserSeller();
