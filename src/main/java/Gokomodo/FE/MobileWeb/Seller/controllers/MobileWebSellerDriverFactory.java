...
public class MobileWebSellerDriverFactory extends MobileWebSellerBaseMethod {
...
//        new MobileWebBuyerWebDriverFactory();
        ...
        if (MobileWebSellerInitMethod.VideoFeature.toLowerCase().contains("enabledfailed")) {
            setupVideoRecordingFailedOnly();
        } else if (MobileWebSellerInitMethod.VideoFeature.toLowerCase().contains("enabledall")) {
    ...
    public MobileWebSellerDriverFactory() {
