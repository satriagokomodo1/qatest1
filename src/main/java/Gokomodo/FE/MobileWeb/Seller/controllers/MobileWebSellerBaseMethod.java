...
import Gokomodo.FE.MobileWeb.Seller.utils.MobileWebSellerEnvironmentSetup;
...
public class MobileWebSellerBaseMethod {
    ...
    public MobileWebSellerBaseMethod() {
    ...
    public void beforeClass(String emulator, String platformName, String deviceName) throws Exception {
        ...
        try {
            ...
            url = new URL(MobileWebSellerInitMethod.GetAppiumUrl);
            switch (platformName) {
                case "Android":
...
//                    desiredCapabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, GetIOSPlatformVersion);
            ...
            driver.get(MobileWebSellerInitMethod.WebsiteURLSeller);
            setDriver(driver);
        } catch (Exception e){
            throw e;
        }
    ...
    {
        URL aURL = new URL(MobileWebSellerInitMethod.WebsiteURLSeller);
    ...
    public void scrollDown() {
        ...
        MobileWebSellerW3cActions.doSwipe(getDriver(), start, end, 1000);  //with duration 1s
    ...
    public void scrollUp() {
        ...
        MobileWebSellerW3cActions.doSwipe(getDriver(), end, start, 1000);  //with duration 1s
    ...
    public void afterClass() {
        MobileWebSellerEnvironmentSetup.environmentSetup();
        getDriver().quit();
    }
