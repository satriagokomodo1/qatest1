package Gokomodo.FE.MobileWeb.Seller.listeners;

import Gokomodo.FE.MobileWeb.Buyer.controllers.MobileWebBuyerBaseMethod;
import Gokomodo.FE.MobileWeb.Buyer.utils.MobileWebBuyerAllureAttachments;
import org.testng.*;


public class MobileWebSellerAllureListener extends MobileWebBuyerBaseMethod implements ITestListener, ISuiteListener, IInvokedMethodListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        MobileWebBuyerAllureAttachments.saveFullPageScreenshot(Name, getDriver());
    }
